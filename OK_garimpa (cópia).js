...
function mostraVs() {
    ...
    // a variável abaixo servirá quando se faça map na listaGarimpada. Se ref. ao total dos versículos de uma passagem solicitada:
    ...
    listaGarimpada.map(cadaPassagem => {
        ...
        if (cadaPassagem.match("-")) {
            ...
            // acima: ALÉM do versInicial tem mais nroVersiculosExtras. (Ex.: 15-17 = 15, 16, 17) - *ADICIONAR FUTURAM. / ERRO?
        }else{
        ...
        cadaPassagem = cadaPassagem.replace(/-.*/, "").trim()
            ...
            if (a[0] === cadaPassagem) {
                ...
                for(rep=0; rep <= nroVersiculosExtras; rep++){
                    ...
                    if(botaoPressionado !== "HB"){
                        ...
                        cadaPassagemHb = `<strong>${bibliaSelecionada[b+rep][0]}:</strong> "${bibliaSelecionada[b+rep][1]}"<br><br>`
